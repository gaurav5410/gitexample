...
import com.nextgen.dto.AgentDTO;
...
public class AuthenticationController {
	...
	public ResponseEntity<?> authenticationRequest(@RequestBody AuthenticationRequest authenticationRequest)
		...
		try {
			...
			final AgentDTO agent = null;/*userService.getAgentDetails(authenticationRequest.getUsername());*/
			/*agent.setUserEmail(authenticationRequest.getUsername());
			agent.setToken(token);*/
			return new ResponseEntity<Object>(new BaseResponse(SecurityError.LOGIN_SUCCESS.getHttpStatus().value(),
					SecurityError.LOGIN_SUCCESS.getDescription(), agent), HttpStatus.OK);
